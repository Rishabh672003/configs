#source ~/scripts/zsh-autocomplete/zsh-autocomplete.plugin.zsh
...
alias rsss='sudo zsh $HOME/mirrors-and-hosts/rate-mirrors-arch.sh'
...
alias m='mocp'
alias hosts='cd $HOME/mirrors-and-hosts/ && sudo zsh ./hosts-maker.sh'
